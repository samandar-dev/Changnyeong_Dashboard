...
export default function WeeklyTopSpots({ setPopularName }) {
    ...
    const arr = [
        ...
        { id: 9, icon: icon9, status: "up", name: "창녕스포츠파크", percentage: 22 },
        { id: 10, icon: icon10, status: "down", name: "옥천계곡", percentage: 13 },
        { id: 11, icon: icon11, status: "up", name: "관룡사", percentage: 6 },
        { id: 12, icon: icon12, status: "down", name: "창녕스포츠파크", percentage: 22 },
        { id: 13, icon: icon13, status: "up", name: "옥천계곡", percentage: 13 },
        { id: 14, icon: icon14, status: "up", name: "관룡사", percentage: 6 },
